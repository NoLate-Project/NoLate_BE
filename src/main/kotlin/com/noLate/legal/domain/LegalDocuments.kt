...
object LegalDocuments {
    val termsOfService = LegalDocumentDto(
        ...
        sections = listOf(
            ...
            section(
                ...
                "SNS 로그인은 선택한 제공자의 인증 결과를 이용하며, 해당 제공자의 정책과 이용 조건이 함께 적용될 수 있습니다.",
                "회원은 앱의 회원 탈퇴 기능을 통해 언제든지 계정 삭제를 요청할 수 있습니다.",
            ),
            section(
                "3. 서비스 제공",
                "NoLate는 일정 생성·수정·삭제, 외부 캘린더 일정 가져오기, 장소 검색, 이동 경로와 예상 소요시간, 출발 알림 및 일정 공유 기능을 제공합니다.",
                "경로와 도착 예상시간은 외부 교통·지도 데이터와 당시 상황을 바탕으로 한 참고 정보이며 실제 이동 결과와 다를 수 있습니다.",
                "캘린더, 위치, 알림 등 기기 권한을 허용하지 않으면 관련 기능 일부가 제한될 수 있으며 가능한 경우 직접 입력 수단을 제공합니다.",
            ),
            section(
                "4. 회원의 의무",
                "회원은 타인의 계정이나 개인정보를 도용하거나 서비스 운영을 방해해서는 안 됩니다.",
                "일정 공유 시 공유할 권한이 있는 정보만 사용해야 하며 상대방의 개인정보와 권리를 침해해서는 안 됩니다.",
            ),
            section(
                "5. 서비스 변경과 제한",
                "안정적인 운영, 보안, 법령 준수 또는 외부 제공자의 정책 변경을 위해 서비스의 일부가 변경되거나 일시 중단될 수 있습니다.",
                "중요한 변경은 앱 또는 서비스 공지 수단으로 안내합니다.",
            ),
            section(
                "6. 책임과 문의",
                "NoLate는 고의 또는 중대한 과실 없이 발생한 외부 서비스 장애, 통신 장애 또는 사용자의 설정·입력 오류에 대해 법령이 허용하는 범위에서 책임을 제한할 수 있습니다.",
                "약관 및 서비스 이용 문의: support@nolate.jinuk.dev",
            ),
        ),
    )

    val privacyCollectionConsent = LegalDocumentDto(
        type = LegalDocumentType.PRIVACY_COLLECTION_CONSENT,
        title = "개인정보 수집·이용 동의",
        version = "2026.07.16",
        effectiveDate = "2026-07-16",
        ...
        sections = listOf(
            ...
            section(
                ...
                "인증 과정에서 생성되는 정보: access token, refresh token 및 토큰 만료 정보",
            ),
            section(
                "3. 보유 및 이용 기간",
                "회원 탈퇴 시까지 보유·이용하며, 관계 법령에 따라 보존 의무가 있는 정보는 해당 기간 동안 분리 보관 후 파기합니다.",
                "로그아웃 또는 회원 탈퇴 시 인증 토큰은 더 이상 로그인 목적으로 사용하지 않습니다.",
            ),
            section(
                "4. 동의 거부 권리와 영향",
                "이용자는 개인정보 수집·이용 동의를 거부할 수 있습니다.",
                "다만 위 정보는 계정 생성과 회원별 서비스 제공에 필요한 최소 정보이므로 동의하지 않으면 회원가입을 진행할 수 없습니다.",
            ),
        ),
    )
