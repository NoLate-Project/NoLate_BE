...
data class SchedulePushJobDto(
    ...
    val lastLiveFetchedAt: Instant?,
    val lastLiveTravelMinutes: Int?,
    val lastEtaSource: TrafficSource?,
    val lastEtaStale: Boolean?,
    val lastEtaFailureReason: String?,
    val lastEtaRouteFingerprint: String?,
    ...
    companion object {
        fun fromEntity(entity: SchedulePushJob): SchedulePushJobDto {
            return SchedulePushJobDto(
                ...
                lastLiveFetchedAt = entity.lastLiveFetchedAt,
                lastLiveTravelMinutes = entity.lastLiveTravelMinutes,
                lastEtaSource = entity.lastEtaSource,
                lastEtaStale = entity.lastEtaStale,
                lastEtaFailureReason = entity.lastEtaFailureReason,
                lastEtaRouteFingerprint = entity.lastEtaRouteFingerprint,
                lastTrafficChangeMinutes = entity.lastTrafficChangeMinutes,
