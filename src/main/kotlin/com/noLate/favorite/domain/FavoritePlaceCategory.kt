...
@Entity
@Table(name = "favorite_place_categories")
@Comment("사용자별 즐겨찾기 장소 카테고리")
class FavoritePlaceCategory(
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Comment("즐겨찾기 장소 카테고리 PK")
    var id: Long? = null,
    ...
    fun toDto(): FavoritePlaceCategoryDto {
        return FavoritePlaceCategoryDto(
            id = id,
            name = name,
            color = color,
            iconKey = iconKey,
