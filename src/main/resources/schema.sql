...
CREATE TABLE IF NOT EXISTS schedule_push_job (
    ...
    last_eta_failure_reason VARCHAR(500) NULL COMMENT 'Last ETA fallback or provider failure reason',
    last_traffic_change_minutes INT NULL COMMENT 'Last observed ETA delta in minutes',
    last_changed_at DATETIME(6) NULL COMMENT 'Time when ETA last changed',
